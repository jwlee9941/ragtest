...
def create_vectorstore(_embeddings_model):
    return FAISS.load_local('db4_3000(300)ocr/faiss', _embeddings_model, allow_dangerous_deserialization=True)
...
def setup_qa_chain(_vectorstore):
    ...
    return RetrievalQAWithSourcesChain.from_chain_type(
        llm=llm,
        chain_type="stuff",
        retriever=_vectorstore.as_retriever(search_kwargs={'k': 2}, search_type="mmr"),
